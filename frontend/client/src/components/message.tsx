...
const ToolPartRenderer = ({
  ...
  if (isMcpApproval) {
    return (
      // Keep open only while awaiting the user's decision — the Allow/Deny
      // actions live inside the collapsible content. Once resolved, collapse
      // so only the summary row shows by default.
